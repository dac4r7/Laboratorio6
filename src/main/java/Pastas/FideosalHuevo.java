 ...
 * @author diego
 */
public class FideosalHuevo extends Pastas {
    ...
    public void descripcion() {
      ...
      System.out.println("TIPO: " + obtenerTipo() + "  CANTIDAD DE kg: " + obtenerCantidad());
        System.out.println("PRECIO POR kg: $" + getPrecio()+"  SUBTOTAL: $" + (obtenerCantidad() * getPrecio()));
    }
